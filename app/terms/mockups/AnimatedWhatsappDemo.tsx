	...
	return (
		...
		>
			...
			<div
				ref={scrollRef}
				aria-hidden="true"
				className="min-h-0 flex-1 overflow-y-auto bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,.78),transparent_35%)] px-2.5 py-3 scrollbar-none [&::-webkit-scrollbar]:hidden"
			>
